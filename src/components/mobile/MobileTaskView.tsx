        ...
        {isExp && (
          <div className="border-t px-3 pb-3 pt-2 space-y-2 bg-gradient-to-b from-muted/20 to-muted/5">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div><label className="text-[9px] text-teal-600 font-semibold">Assigner</label><span className="block text-xs font-medium px-2 py-1 bg-muted/30 rounded-lg">{members.find((m) => m.id === (task as any).assigner_id)?.name || '-'}</span></div>
